...
module DOGCM_IO_Restart_mod 
  ...
  ! Public procedure
  !
  public :: DOGCM_IO_Restart_Init, DOGCM_IO_Restart_Final

  public :: DOGCM_IO_Restart_Create
  public :: DOGCM_IO_Restart_RegistVar
  public :: DOGCM_IO_Restart_Output
  interface DOGCM_IO_Restart_HistPut
     module procedure DOGCM_IO_Restart_HistPut1D
     module procedure DOGCM_IO_Restart_HistPut2D
     module procedure DOGCM_IO_Restart_HistPut3D
  end interface DOGCM_IO_Restart_HistPut
  public :: DOGCM_IO_Restart_HistPut  


  public :: DOGCM_IO_Restart_Input  
  interface DOGCM_IO_Restart_HistGet
     module procedure DOGCM_IO_Restart_HistGet1D
     module procedure DOGCM_IO_Restart_HistGet2D
     module procedure DOGCM_IO_Restart_HistGet3D
  end interface DOGCM_IO_Restart_HistGet
  public :: DOGCM_IO_Restart_HistGet
  
  public :: DOGCM_IO_Restart_IsOutputTiming
  ...
  ! Private variable
  !
  character(*), parameter:: module_name = 'DOGCM_IO_Restart_mod' !< Module Name
...
contains
  ...
  end subroutine DOGCM_IO_Restart_Init
  ...
  logical function DOGCM_IO_Restart_isOutputTiming(CurrentTimeSec)
  ...
  end function DOGCM_IO_Restart_isOutputTiming
  ...
  end subroutine DOGCM_IO_Restart_HistPut1D
  ...
  end subroutine DOGCM_IO_Restart_HistPut2D
  ...
  end subroutine DOGCM_IO_Restart_HistPut3D

  !-----------------------------------------------------------------
  
  subroutine DOGCM_IO_Restart_RegistVar( &
  ...
  end subroutine DOGCM_IO_Restart_RegistVar
  ...
  !!
  !!
  subroutine DOGCM_IO_Restart_Output()
  ...
  end subroutine DOGCM_IO_Restart_HistGet1D

  subroutine DOGCM_IO_Restart_HistGet2D(       &
       & varName,                               & ! (in)
       & var                                    & ! (in)
       & )
  ...
  end subroutine DOGCM_IO_Restart_HistGet2D

  subroutine DOGCM_IO_Restart_HistGet3D(       &
       & varName,                               & ! (in)
       & var                                    & ! (in)
       & )
  ...
  end subroutine DOGCM_IO_Restart_HistGet3D
  
  !> @brief 
  !!
  !!
  subroutine DOGCM_IO_Restart_Input()
  ...
  end subroutine DOGCM_IO_Restart_Input
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!
  !!
  subroutine DOGCM_IO_Restart_Create()
  ...
  end subroutine DOGCM_IO_Restart_Create
  
end module DOGCM_IO_Restart_mod
