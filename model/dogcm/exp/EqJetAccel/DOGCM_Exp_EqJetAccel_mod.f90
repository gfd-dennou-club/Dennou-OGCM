...
!!
!!
module DOGCM_Exp_EqJetAccel_mod 
  ...
  ! Private variable
  !
  character(*), parameter:: module_name = 'DOGCM_Exp_EqJetAccel_mod' !< Module Name
  integer :: expCaseNum
...
end module DOGCM_Exp_EqJetAccel_mod
