...
module SimParameters_mod
  ...
  real(DP), parameter :: meanDepth = 3000d0!2.94d04 / Grav
  real(DP), parameter :: refDens = 1000d0
  integer, parameter :: delTime       = 45d0
  ...
  character(STRING) :: gridFilePath = "/home/ykawai/workspace/Dennou-OGCM/tool/glevel4_shoreline3.nc"!grid/grid-glevel5_itr.nc"
  character(STRING) :: gridUsageFilePath = "/home/ykawai/workspace/Dennou-OGCM/tool/glevel4_shoreline3_MeshUsage.nc"
