...
\chapter{はじめに}
\markright{\arabic{chapter} はじめに}
%%
\input{model}
%%
\input{approx_sol}
%%
\input{approx_sol_equator}
%%%%%%%%%%%%%%%%%%%%%
% 付録
\newpage
\input{approx_sol_form_applyBC}
\newpage
\input{approx_sol_equator_deriv}
%%
