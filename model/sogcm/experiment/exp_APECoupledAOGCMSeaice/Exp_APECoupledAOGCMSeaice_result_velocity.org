#+TITLE: 大気海洋海氷結合モデルによる水惑星実験(標準実験): 結果 ~ 風速・流速の様子
#+AUTOHR: 河合 佑太
#+LANGUAGE: ja
#+OPTIONS: H:2 ^:{}
...
- 子午面分布(海洋)
   ...
   #+CALL: create_FigsTable("東西流速[m/s], 質量流線関数[Sv=10^{9} kg/s]の子午面分布", "yz_{U,MassStreamFunc}_mplane.jpg", "./expdata_ocn/exp_S1366/") :results value raw :exports results
