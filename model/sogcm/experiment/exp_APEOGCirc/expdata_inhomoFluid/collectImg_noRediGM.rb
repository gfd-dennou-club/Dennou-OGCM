...
LAST_DAY= 1825000  #[day]
LASTDATE_SUFFIX="_5000yr"
YT_SUFFIX="_0-5000yr"
...
yz_BoulusMassStrFunc_mplane = VarNoAnimFig.new("", "BolusMStreamFunc", "t=#{LAST_DAY},lat=-90:90", "10", "-100:100", "yz", "mplane#{LASTDATE_SUFFIX}", "--title 'BolusMassStreamFunc' --nocont")
yz_ResMassStrFunc_mplane = VarNoAnimFig.new("", "ResMStreamFunc", "t=#{LAST_DAY},lat=-90:90", "10", "-100:100", "yz", "mplane#{LASTDATE_SUFFIX}", "--title 'ResidualMassStreamFunc' --nocont")
...
exps = [
        Exp.new("exp_EOSL_HDIFF_CA", 
                "#{DATASTORAGE_DIR}/exp_EOSL_HDIFF_CA2/", ""), 
        Exp.new("exp_EOSQ_HDIFF_CA", 
                "#{DATASTORAGE_DIR}/exp_EOSQ_HDIFF_CA2/", ""), 
        Exp.new("exp_EOSJM95_HDIFF_CA", 
                "#{DATASTORAGE_DIR}/exp_EOSJM95_HDIFF_CA2/", ""), 
]
...
extra_exps = [ 
              ...
              Exp.new("exp_EOSComp_noRediGM", "./EOSComp/noRediGM/"), 
             ]
...
t_KECompari_EOSComp = NoAnimOverplotFig.new("KEAvg_EOSCompari", 
                     "#{getExpDirPath("EOSQ_HDIFF_CA")}/KEAvg.nc, \
                      #{getExpDirPath("EOSL_HDIFF_CA")}/KEAvg.nc, \
                      #{getExpDirPath("EOSJM95_HDIFF_CA")}/KEAvg.nc", 
                     "KEAvg,KEAvg,KEAvg", "t=0:1e10", "", "0:0.05", "--title 'K.E.(global mean)'") 
t_KECompari_EOSComp.createFigure(getExpDirPath("EOSComp_noRediGM"))
