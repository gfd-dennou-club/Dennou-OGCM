...
- テスト計算
  ...
  - 水惑星設定における海洋大循環の数値実験
     - [[./../experiment/exp_WindDrivenCirculation/Exp_WindDrivenCirculation_homoFluid.html][水惑星設定における軸対称風成循環の数値実験1:密度一様]]
       - [[./../experiment/exp_WindDrivenCirculation/note/axisym_windcirc_homoFluid/main.pdf][軸対称風成循環の漸近級数解の導出ノート]]
     - [[./../experiment/exp_APEOGCirc/Exp_WindDrivenCirculation_inhomoFluid.html][水惑星設定における軸対称風成循環の数値実験2:密度非一様]]
...
#+CALL: create_MeetingLogTable("2014", "2014-{11-17,07-16,06-26,05-28,04-23}") :results value raw :exports results
